...
const Hero = () => {
  ...
  return (
    <>
      <div className="flex w-full h-screen mobile about">
        {/* <div className="absolute inset-0 bg-black/10 md:hidden flex" /> */}
        <div className="absolute inset-0 bg-[url(/overlay.png)] " />

        <div
          className="flex box flex-col justify-end pb-30 px-5 md:px-7 lg:px-10 xl:px-12 2xl:px-15 space-y-6 max-w-104.25 md:max-w-155
          lg:max-w-180
          xl:max-w-204.25
          bg-transparent
          lg:pb-29.25          "
